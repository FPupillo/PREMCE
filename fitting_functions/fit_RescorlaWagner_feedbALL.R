...
fit_RescorlaWagner_feedbALL<-function(data,alphaBound, betaBound, initialQ){
  ...
  obfunc<-function(x) lik_RescorlaWagner_feedbALL(data, x[1], x[2],1, initialQ) # this function is similar to the MATLAB "handle" function
