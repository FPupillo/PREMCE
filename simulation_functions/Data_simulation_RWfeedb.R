...
source("computational_model/simulation_functions/simulate_RescorlaWagner_feedb.R")
...
for (simul in 1:sims){
  for (a in alpha){
  for (b in beta){
  sim<-simulate_RescorlaWagner_feedb(Data=day2list,
                                     alpha =a , beta = b,  initialQ = 0.25)
