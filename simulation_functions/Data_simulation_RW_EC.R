#------------------------------------------------------------------------------#
# Data simulation for RW evaluative-counterfactual
...
for (simul in 1:sims){
  ...
  sim<-simulate_RescorlaWagner_EC(Data=Data,
...
# save the data
#save(list = c("simPerf", "simData"), file = "output_files/simulationData_EC.Rdata")
load("output_files/simulationData_EC.Rdata")
...
ggsave("output_files/simulatedData_RW_EC.jpg")
...
# arrange the two
OptPerf<-grid.arrange(p1, p2, p3,ncol=2)

ggsave("figures/optimalperf_RW_EC.jpg",OptPerf)
  
sim<-simulate_RescorlaWagner_EC(Data=Data,
                                    alpha =0.50 , beta = 10,  initialV = 0.25)
...
ggsave("figures/estimatedCP_RW_EC_alpha=0.50_beta=10.jpg")
