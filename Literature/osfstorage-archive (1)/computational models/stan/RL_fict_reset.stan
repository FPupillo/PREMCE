data {
  ...
  int<lower=0,upper=1> reset[T]; // indication of prob change
}
...

  {
    for (s in 1:S){
       ...
       for (t in 1:T)  {
          ...
          // update value of unchosen option 
          Q[3-choice[s,t]] += alpha[s] * (-reward[s,t]-Q[3-choice[s,t]]);
    ...
    for (s in 1:S){
      ...
      log_lik[s]=0;
       ...
       for (t in 1:T)  {
          ...
          pe_nc[s,t]=(-reward[s,t]-Q[3-choice[s,t]]);
        } // end of t loop (T trials)
