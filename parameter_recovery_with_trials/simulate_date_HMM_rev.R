#------------------------------------------------------------------------------#
# simulating trials switch points and character and analyse results - HMM revised
...
source("simulation_functions/simulate_HMM_rev.R")
source(("helper_functions/softmax.R"))
source(("helper_functions/chooseMultinom.R"))
source(("helper_functions/BICcompute.R"))
source("likelihood_functions/lik_HMM_rev.R")
source("fitting_functions/fit_HMM_rev.R")
...
# simulate data
sim<-simulate_HMM_rev(Data=Data,c=0.4, 
          gamma = 0.1,  
           initialPs = 0.25)
...
ggsave(filename = "figures/estimatedCP_HMMrev_c=0.4_gamma=0.1.jpg") 
